...
|  |  |  |  |
| --- | --- | --- | --- |
| **10** CVEs filed | **36** threat families | **< 1ms** overhead | **SOC 2 · CMMC · §1513** compliance artifacts |
...
Designed for LangChain, LlamaIndex, AutoGen, CrewAI, and n8n. Works with any framework using the MCP SDK.
...
| CVEs filed against MCP-based agents | **10** |
...
To contribute a rule family: [CONTRIBUTING.md](CONTRIBUTING.md)  
To report a CVE: [SECURITY.md](SECURITY.md)
