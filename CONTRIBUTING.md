...
**File a CVE.** See [SECURITY.md](SECURITY.md). Every confirmed CVE against an MCP-based agent runtime gets a corresponding Aiglos rule.
...
1. Fork the repo
2. Add your rule under `/aiglos/rules/T{XX}_{NAME}.py`
3. Add tests under `/tests/test_T{XX}.py`
4. Open a PR with: threat description, attack example, CVSS estimate, and affected frameworks
5. Link any related CVE or public disclosure
