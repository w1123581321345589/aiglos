  ...
  const sessionData = [
    {
      ...
      authorizedGoal: "refactor auth module, add oauth2 + token rotation",
    ...
    },
    {
      ...
      authorizedGoal: "debug ws memory leak, fix connection pooling",
    ...
    },
    {
      ...
      authorizedGoal: "generate api docs + integration tests for payments",
    ...
    },
    {
      ...
      authorizedGoal: "add rate limiting + ddos protection on public api",
    ...
    },
    {
      ...
      authorizedGoal: "scan for hardcoded secrets/creds",
  ...
  const eventData = [
    {
      ...
      description: "Agent drifted from rate limiting into credential store access",
    ...
    },
    {
      ...
      description: "AKIA* pattern AWS key in execute_command args",
    ...
    },
    {
      ...
      description: "Tool call freq spiked 4x over 5min window",
    ...
    },
    {
      ...
      description: "Tried to run sudo, blocked by policy",
    ...
    },
    {
      ...
      description: "Read auth module source",
    ...
    },
    {
      ...
      description: "Attestation doc generated and signed",
    ...
    },
    {
      ...
      description: "ghp_ token found in .env.local",
    ...
    },
    {
      ...
      description: "Shifted from file ops to external network requests",
    ...
    },
    {
      ...
      description: "Session ended cleanly, high integrity",
    ...
    },
    {
      ...
      description: "Shell metachar injection in tool args",
    ...
    },
    {
      ...
      description: "Wrote token rotation impl",
    ...
    },
    {
      ...
      description: "Grep for secret patterns across repo",
