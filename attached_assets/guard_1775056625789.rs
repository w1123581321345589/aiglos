...
impl Guard {
    ...
    pub fn before_tool_call(&mut self, tool_name: &str, args: &[(&str, &str)]) -> GuardResult {
        ...
        // Serialize args to a string for pattern matching
        ...
        // Apply trust decay with consecutive amplifier
        ...
        // Composite score: rule * 0.7 + (1 - trust) * 0.3
    ...
    ///
    /// Automatically persists to ~/.aiglos/forensics.db if the `forensics`
    /// feature is enabled.
...
fn iso_now() -> String {
    let ts = SystemTime::now()
        ...
        .unwrap_or_default()
        .as_secs();
    // Simplified ISO 8601 -- production would use chrono
    format!("{}Z", ts)
}
...
mod tests {
    ...
    fn test_exfil_blocked() {
        ...
        // T01 should fire at enterprise policy
    ...
    fn test_pth_inject_critical() {
        ...
        // T81 is critical -- blocks even in permissive
    ...
    fn test_trust_decay_consecutive() {
        ...
        // Trust should decay faster on consecutive hits
        let d1 = t0 - t1;
        let d2 = t1 - t2;
