...
that 5 malicious texts achieve 98.2% retrieval success. No patent
covers RAG pipeline taint propagation for AI agents.

The novel claim: it is not enough to detect a poisoned document at
...
class RAGGuard:
    ...
    def record_inference(
        ...
        This is the novel claim: when an inference uses a tainted document,
