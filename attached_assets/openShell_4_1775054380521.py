...
"hermes":             "Hermes agent (NousResearch supervisor pattern)",
    "hermes-agent":       "Hermes agent (NousResearch)",
    "nous-hermes":        "NousResearch Hermes",
    "nous-research/hermes": "NousResearch Hermes agent",
    "hermes":              "Hermes agent (NousResearch) — supervisor/orchestrator",
    "hermes-agent":        "Hermes agent (NousResearch)",
    "nous-hermes":         "Hermes agent (NousResearch)",
    ...
    "hermes-agent":   "Hermes supervisor agent (NousResearch)",
