...
[![489 tests](https://img.shields.io/badge/tests-489_passing-000?style=flat-square&labelColor=000)](tests/)

|  |  |  |  |  |  |
|---|---|---|---|---|---|
| **38** threat families | **3** execution surfaces | **8** campaign patterns | **Self-improving rules** | **Belief-layer + RL security** | **NDAA §1513 · EU AI Act · SOC 2 · CMMC** |
...
**REWARD_MANIPULATION** — a blocked operation followed by a positive reward signal in the same session. Indicates an attempt to train the model toward behavior that Aiglos blocked. The complete poison-reward-exploit loop in a single session window.
